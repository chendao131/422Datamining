...
public class sample {
	...
	public static LinkedList<point> sampling(LinkedList<point> V,double k,double e) throws IOException{
		...
		out.addAll(R);
		out.addAll(S);
		FileWriter fw = new FileWriter("/home/nits/422P/localresult/removeddata.txt");
