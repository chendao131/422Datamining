...
public static void main(String[] args) throws Exception {
 ...
 FileInputFormat.addInputPath(job1, new Path("/Users/lishuai/Study/CS422/inputs"));
 FileOutputFormat.setOutputPath(job1, new Path("/Users/lishuai/Study/CS422/outputs"));
 //System.exit(job1.waitForCompletion(true) ? 0 : 1);
 job1.waitForCompletion(true);
 	FileReader fr = new FileReader("/Users/lishuai/Study/CS422/outputs/part-r-00000");
